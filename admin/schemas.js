...
window.CMS_SCHEMAS = {
  ...
  hero: {
    ...
    fields: [
      ...
      { key: 'ctaLabel',       label: 'CTA — libellé bouton', type: 'string', help: 'Ex. "Venir essayer". Vide = pas de bouton.' },
      { key: 'ctaHref',        label: 'CTA — destination',     type: 'string', help: 'Ancre interne (ex. "#creneaux") ou URL externe.' },
      { key: 'scrollLabel',    label: 'Scroll cue — libellé',  type: 'string', help: 'Petit texte sous le chevron, ex. "Découvrir le club".' },
    ],
  },
    ...
    fields: [
      ...
      { key: 'items', label: 'Cartes disciplines', type: 'array',
        ...
        item: { fields: [
          ...
          { key: 'focal',    label: 'Cadrage',               type: 'focal', imageKey: 'img' },
        ]},
      },
    ],
  },
    ...
    fields: [
      ...
      { key: 'items', label: 'Profs', type: 'array',
        ...
        item: { fields: [
          ...
          { key: 'focal',    label: 'Cadrage',                       type: 'focal', imageKey: 'photo' },
  ...
  club: {
    ...
    fields: [
      ...
      { key: 'imageAlt',      label: 'Texte alt image',    type: 'string' },
      { key: 'imageFocal',    label: 'Cadrage',            type: 'focal', imageKey: 'image' },
  ...
  rejoindre: {
    ...
    fields: [
      ...
      { key: 'titleLine1',    label: 'Titre ligne 1',      type: 'string' },
      { key: 'titleLine2',    label: 'Titre ligne 2 (italique accent)', type: 'string' },
      { key: 'venueEyebrow',  label: 'Eyebrow bloc pratique', type: 'string', help: 'Ex. "Pratique". Au-dessus de Lieu/Contact.' },
      { key: 'scheduleEyebrow', label: 'Eyebrow bloc créneaux', type: 'string', help: 'Ex. "Créneaux hebdomadaires". Au-dessus du tableau d\'horaires.' },
      { key: 'venue', label: 'Lieu + contact', type: 'object',
        schema: { fields: [
          { key: 'eyebrow',         label: 'Eyebrow lieu',     type: 'string', help: 'Ex. "Lieu"' },
          { key: 'name',            label: 'Nom du lieu',       type: 'string', help: 'Ex. "Gymnase Robert Pras"' },
          { key: 'address',         label: 'Adresse',           type: 'string' },
          { key: 'contactEyebrow',  label: 'Eyebrow contact',   type: 'string', help: 'Ex. "Contact"' },
          { key: 'contactEmail',    label: 'Email',             type: 'string' },
          { key: 'contactPhone',    label: 'Téléphone affiché', type: 'string', help: 'Format lisible, ex. "06 31 58 54 60"' },
          { key: 'contactPhoneHref', label: 'Téléphone (lien tel:)', type: 'string', help: 'Format compact, ex. "tel:+33631585460"' },
        ]},
      },
    ...
    fields: [
      ...
      { key: 'tiles', label: 'Vignettes', type: 'array',
        ...
        item: { fields: [
          { key: 'src',   label: 'Image',          type: 'image' },
          { key: 'alt',   label: 'Texte alt',      type: 'string' },
          { key: 'focal', label: 'Cadrage',        type: 'focal', imageKey: 'src' },
