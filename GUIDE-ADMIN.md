...
| **Accroche** | Une ligne, 90 caractères maximum. Ex. « Rapière française & italienne · bolonaise ». Si vous cochez l'accroche dorée ci-dessous, **encadrez d'astérisques la partie à dorer** : `*Top 1 % mondial* · épée longue acier` met en or « Top 1 % mondial » et laisse le reste de la ligne dans sa couleur normale. C'est l'écriture déjà employée par les titres du site pour désigner le mot mis en valeur. Les astérisques ne s'affichent jamais ; pour en écrire une vraie, tapez `\*`. |
| **Accroche dorée (palmarès)** | Décochée par défaut. Cochée, **la partie entre astérisques** de l'accroche s'écrit en lettres d'or, un reflet la traverse une fois à l'ouverture de la page — sur la fiche **comme sur la carte de l'accueil**. La fiche prend en plus quelques ornements dorés : le trait sous l'accroche, la ligne d'armes, le bouton du lien externe. Si vous n'avez mis aucune astérisque, c'est toute l'accroche qui est dorée. **À réserver à un titre ou à un rang réel** (un classement, un podium) : si toutes les fiches sont dorées, plus aucune ne l'est. Rien d'autre ne change, et le texte reste exactement celui que vous avez écrit. |
